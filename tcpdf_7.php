...
$patch_array[0]['points'] = array(
    ...
    0.00,0.33);
$patch_array[0]['colors'][0] = array('r' => 290, 'g' => 0, 'b' => 0);
$patch_array[0]['colors'][1] = array('r' => 255, 'g' => 255, 'b' => 0);
$patch_array[0]['colors'][2] = array('r' => 0, 'g' => 255,'b' => 0);
$patch_array[0]['colors'][3] = array('r' => 255, 'g' => 155,'b' => 0);
...
$patch_array[1]['points'] = array(
    ...
    1.5,1.33);
$patch_array[1]['colors'][0]=array('r' => 255, 'g' => 0, 'b' => 500);
...
$patch_array[3]['points'] = array(
    ...
    0.8,0.67);
$patch_array[3]['colors'][0] = array('r' => 0, 'g' => 800, 'b' => 0);
$patch_array[3]['colors'][1] = array('r' => 500, 'g' => 0, 'b' => 255);
...
<br>
<br>
<h1 style="text-align:center">I hope the holidays bring a chance to rest and recharge.</h1>
<h3 style="text-align:center">And</h3>
<h1 style="text-align:center">May your holidays sparkle with joy and laughter.</h1>
EOD;
$pdf->writeHTMLCell(0, 0, '', '', $html, 0, 1, 0, true, '', true);

$pdf->Ln(20);
// set general stretching (scaling) value
$pdf->Cell(0, 0, 'Happy Holidays Everyone!!!', 1, 1, 'C', 0, '', 2);
